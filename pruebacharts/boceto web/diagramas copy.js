...
const ventana_modelo = document.querySelector('.contwebgl')
const modelo = document.getElementById('open_model')
const close_modelo = document.getElementById('close_model')

modelo.addEventListener('click', ()=>{
  ventana_modelo.style.display = "flex"
})

close_modelo.addEventListener('click', ()=>{
  ventana_modelo.style.display = "none"
})
